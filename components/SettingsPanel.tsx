      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-3">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-mono font-medium text-(--primary)">{Math.round(settings.quality * 100)}%</span>
          </div>
          <input
            type="range"
            min="0.1"
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <div className="relative w-full">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-medium text-(--text-muted)">W</span>
              <input
                type="number"
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`flex-1 min-w-[60px] text-xs py-2 rounded-md font-medium transition-all border ${isSelected
